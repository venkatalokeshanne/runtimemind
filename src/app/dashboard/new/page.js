      ...
      <div className="bg-surface/95 backdrop-blur-xl border border-border rounded-2xl shadow-md">
        <div className="px-4 sm:px-6 h-16 flex items-center justify-between gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            {/* Status pill */}
            <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 bg-accent/15 rounded-full">
...
function PublishModal({ isOpen, onClose, onPublish, saving, title, wordCount, readTime }) {
  return null; // Replaced by PublishPanel
}
