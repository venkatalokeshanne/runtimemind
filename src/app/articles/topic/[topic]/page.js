...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.runtimemind.com/articles/topic/${encodeURIComponent(decodedTopic.toLowerCase())}`,
    },
    openGraph: {
      title: `${decodedTopic} Articles & Tutorials | RuntimeMind`,
      description: `Read the best ${decodedTopic} articles, tutorials and guides on RuntimeMind.`,
      type: 'website',
      url: `https://www.runtimemind.com/articles/topic/${encodeURIComponent(decodedTopic.toLowerCase())}`,
    },
    twitter: {
